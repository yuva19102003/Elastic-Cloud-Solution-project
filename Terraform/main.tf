...
module "maintenance-sg-inbound-peering" {
  source            = "./modules/vpc/security-group/ingress"
  security-group-id = module.maintenance-security-group.security-group-id
  port              = -1
  protocol          = "icmp"
...
module "efs" {
  source          = "./modules/efs"
  subnet-id       = module.maintenance.private-subnet-id[0]
  security-groups = module.maintenance-security-group.security-group-id
